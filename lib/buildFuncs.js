...
export default class BuildFuncs {
    ...
    jsProcessor(file, packageName, reload = false) {
        ...
        esbuild.build({
            ...
            .catch((e) => {
                ...
                if (this.bs) {
                    this.bs.notify(`<h1 style="background: red; color:black">error in compiling javascript</h1>`, 2000);
                }
                return false
            })
    }
    ...
    sassProcessor(file, packageName, reload = undefined) {
        ...
        try {
            ...
            if (reload) {
                console.log('inher201')
                this.bs.reload()
            }
        } catch(e) {
            log.error('1679589839815', e)
            if (this.bs) {
                this.bs.notify(`<h1 style="background: red; color:black">error in compiling sass</h1>`, 2000);
            }
            return false
        }
        return true
    ...
    postHtmlProcessor(_options = {}) {
        ...
        try {
            ...
            if (options.standalone) {
                ...
                result = `<html data-standalone="true">\n` + result + `\n</html>`
            ...
            console.log(e)
            if (this.bs) {
                this.bs.notify(`<h1 style="background: red; color:black">error in compiling html</h1>`, 2000);
            }
            return false
        }
    }
